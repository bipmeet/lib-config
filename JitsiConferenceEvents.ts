...
export const VIDEOACCESS_CHANGED_FOR_PARTICIPANT = JitsiConferenceEvents.VIDEOACCESS_CHANGED_FOR_PARTICIPANT;
export const VIDEO_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS = JitsiConferenceEvents.VIDEO_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS;
export const RAISE_HAND_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS = JitsiConferenceEvents.RAISE_HAND_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS;
export const MICROPHONE_ACCESS_CHANGED_FOR_PARTICIPANT = JitsiConferenceEvents.MICROPHONE_ACCESS_CHANGED_FOR_PARTICIPANT;
export const MICROPHONE_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS = JitsiConferenceEvents.MICROPHONE_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS;
export const SCREEN_SHARING_ACCESS_CHANGED_FOR_PARTICIPANT = JitsiConferenceEvents.SCREEN_SHARING_ACCESS_CHANGED_FOR_PARTICIPANT;
